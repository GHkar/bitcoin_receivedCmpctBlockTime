...
def open_debug_log(collection):
    ...
    while True:
        ...
        try:
            ...
            if pattern_receivedBlockTxn(line) and get_hash:
                find_line = pattern_receivedBlockTxn.search(line)
                requestedTxnSize = int(find_line.group('size'))
            ...
            if get_height:
                make_db_json(cmpct_height, requestedTxnSize)
...
def make_db_json(height, requetedTxnSize):
    global db_json

...
def connect_monogoDB():
    ...
    collection = mydb["4receivedCmpctTime"]
    ...
    while True:
        ...
        try:
            if pattern_startTime.search(line) and not get_startTime:
                ...
                #if startTime > datetime.datetime(2021,5,4,15,00,00) and startTime < datetime.datetime(2021,5,5,15,00,00):
                #if startTime > datetime.datetime(2021,6,22,15,32,43) and startTime < datetime.datetime(2021,6,24,5,46,9):
                #if startTime > datetime.datetime(2021,6,27,14,3,50) and startTime < datetime.datetime(2021,6,29,10,51,8):
                get_startTime = True
                #if startTime > datetime.datetime(2021,6,24,5,46,9):
                #    break
